...
start_server {tags {"repl"}} {
    ...
    start_server {} {
		...
		# comment out not support commands
		if {0} {
            ...
            start_server {} {
                ...
                start_server {} {
                    ...
                    test "Connect multiple slaves at the same time (issue #141), diskless=$dl" {
						...
						#set slave0_dbsize [[lindex $slaves 0] dbsize]
						#set slave1_dbsize [[lindex $slaves 1] dbsize]
						#set slave2_dbsize [[lindex $slaves 2] dbsize]
						#puts "master_dbsize=$master_dbsize, slave0_dbsize=$slave0_dbsize, slave1_dbsize=$slave1_dbsize, slave2_dbsize=$slave2_dbsize"
                        wait_for_condition 500 100 {
