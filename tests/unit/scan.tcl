start_server {tags {"scan"}} {
    ...
    test "SSCAN with integer encoded object (issue #1345)" {
        ...
        r del set
        r sadd set {*}$objects
        set res [r sscan set "" MATCH *a* COUNT 100]
        assert_equal [lsort -unique [lindex $res 1]] {a}
        set res [r sscan set "" MATCH *1* COUNT 100]
    ...
    test "SSCAN with PATTERN" {
        ...
        set res [r sscan mykey "" MATCH foo* COUNT 10000]
    ...
    test "ZSCAN with PATTERN" {
        ...
        set res [r zscan mykey "" MATCH foo* COUNT 10000]
        lsort -unique [lindex $res 1]
    }
    ...
    test "ZSCAN scores: regression test for issue #2175" {
        ...
        set res [lindex [r zscan mykey ""] 1]
